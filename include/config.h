...
#define C2_LEVEL_LOW_CM        80    // Stop pumping — too low / dry-run risk
// SUGGESTION: Add a C2_LEVEL_OVERFLOW_CM (~10 cm) to trigger an alarm or
//             overflow valve if something blocks the outlet.
